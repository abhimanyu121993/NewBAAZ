...
@section('Content-Area')
    ...
    @can('Service_charge_read')
        <div class="card">
            ...
            <div class="card-body">
                <table class="display nowrap" id="servicschange" style="width:100% !important;">
                        ...
                        @foreach ($services as $service)
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        @can('Service_charge_edit')
                                                            <a class="dropdown-item"
                                                                href="{{ route('Backend.servicecharge.edit', $cid) }}"><i class="me-1"
                            ...
                            @can('Service_charge_delete')
                                <form id="delete-form-{{ $cid }}"
                                    action="{{ route('Backend.servicecharge.destroy', $cid) }}" method="post"
                                    style="display: none;">
                                    @method('DELETE')
                                    @csrf
                                </form>
