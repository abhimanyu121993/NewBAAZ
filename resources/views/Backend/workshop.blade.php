                ...
                <form class="needs-validation"
                        ...
                        @if (!isset($editworkshop))
                            <div class="col-md-6 mb-1">
                                ...
                                <input type="text" id="basic-addon-name" name='password' class="form-control"
                                    value="{{ isset($editworkshop) ? $editworkshop->password : '' }}"
                                    placeholder="Enter password" aria-label="password" aria-describedby="basic-addon-name"
                                    required />
                            </div>
                        @endif
                        <div class="col-md-6 mb-1">
                            ...
                            <input type="text" id="basic-addon-name" name='owner_name' class="form-control"
                                value="{{ isset($editworkshop) ? $editworkshop->owner_name : '' }}"
                                placeholder="Enter owner name" aria-label="Name" aria-describedby="basic-addon-name" required />
                        </div>
                        <div class="col-md-6 mb-1">
                    ...
                    @if (isset($editworkshop))
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <img src="{{ asset($editworkshop->pic) }}" class="bg-light-info" alt=""
                                    style="height:100px;width:100px;">
                            </div>
                            <div class="col-sm-4">
                                <img src="{{ asset($editworkshop->gstpic) }}" class="bg-light-info" alt=""
                                    style="height:100px;width:100px;">
                            </div>
                        </div>
                    @endif
    ...
    @can('Workshop_read')
        <div class="card">
            ...
            <div class="card-body" style="overflow-y: auto;">
                <table class="display nowrap" id="workshop" style="width:100% !important;">
                    <thead>
                        <tr>
                            <th>Sr.No</th>
                            <th>Name</th>
                    ...
                    <tbody>
                        @foreach ($workshops as $workshop)
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        @can('Workshop_edit')
                                                            <a class="dropdown-item"
                                                                href="{{ route('Backend.workshop.edit', $eid) }}"><i class="me-1"
                            ...
                            @can('Workshop_delete')
                                <form id="delete-form-{{ $eid }}"
                                    action="{{ route('Backend.workshop.destroy', $eid) }}" method="post"
                                    style="display: none;">
                                    @method('DELETE')
                                    @csrf
                                </form>
