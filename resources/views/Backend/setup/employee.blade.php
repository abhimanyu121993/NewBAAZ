            ...
            <div class="card-body">
                <form class="needs-validation"
                        ...
                        @if (!isset($editemployee))
                            <div class="col-md-6 mb-1">
                                ...
                                <input type="text" id="basic-addon-name" name='password' class="form-control"
                                    value="{{ isset($editemployee) ? $editemployee->password : '' }}"
                    ...
                    <div class="row">
                        ...
                        @if (isset($editemployee))
                            <div class="col-sm-6">
                                <img src="{{ asset($editemployee->pic) }}" class="bg-light-info" alt=""
                        ...
                        @foreach ($employees as $employee)
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        @can('Employee_edit')
                                                            <a class="dropdown-item"
                                                                href="{{ route('Backend.authuser.edit', $eid) }}"><i class="me-1"
                            ...
                            @can('Employee_delete')
                                <form id="delete-form-{{ $eid }}"
                                    action="{{ route('Backend.authuser.destroy', $eid) }}" method="post"
                                    style="display: none;">
                                    @method('DELETE')
                                    @csrf
                                </form>
